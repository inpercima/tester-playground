...
export type MissionsQuery = { __typename?: 'Query', missions?: Array<{ __typename?: 'Mission', name?: string | null } | null> | null };
...
export const MissionsDocument = gql`
  ...
  export class MissionsGQL extends Apollo.Query<MissionsQuery, MissionsQueryVariables> {
    override document = MissionsDocument;
